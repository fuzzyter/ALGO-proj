...
void load_csv(const char* filename)
{
    ...
    fclose(file);
    printf("CSV 파일에서 데이터를 성공적으로 로드했습니다.\n");
}
...
int main()
{
    ...
    load_csv("studentList.csv"); //csv파일 불러오기
